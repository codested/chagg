...
func TestConfigSetGlobalDefaultsAudienceWritesUserConfig(t *testing.T) {
	mock := &changeentry.MockConfigIO{}
	err := configSet("defaults.audience", []string{"public"}, true, mock, false)
	if err != nil {
...
func TestConfigSetGlobalDefaultsAudienceExpandsCSV(t *testing.T) {
	mock := &changeentry.MockConfigIO{}
	err := configSet("defaults.audience", []string{"public,internal"}, true, mock, false)
	if err != nil {
		t.Fatalf("configSet returned error: %v", err)
	}
	if mock.WrittenUserCfg == nil {
...
func TestConfigSetGlobalDefaultsRankWritesUserConfig(t *testing.T) {
	mock := &changeentry.MockConfigIO{}
	err := configSet("defaults.rank", []string{"5"}, true, mock, false)
	if err != nil {
		t.Fatalf("configSet returned error: %v", err)
	}
	if mock.WrittenUserCfg == nil {
...
func TestConfigSetGlobalDefaultsRankRejectsNonInteger(t *testing.T) {
	mock := &changeentry.MockConfigIO{}
	err := configSet("defaults.rank", []string{"notanumber"}, true, mock, false)
	if err == nil {
...
func TestConfigSetGlobalDefaultsRankRejectsMultipleValues(t *testing.T) {
	mock := &changeentry.MockConfigIO{}
	err := configSet("defaults.rank", []string{"1", "2"}, true, mock, false)
	if err == nil {
...
func TestConfigSetGlobalGitWriteAllowWritesUserConfig(t *testing.T) {
	mock := &changeentry.MockConfigIO{}
	err := configSet("git.write.allow", []string{"false"}, true, mock, false)
	if err != nil {
		t.Fatalf("configSet returned error: %v", err)
	}
	if mock.WrittenUserCfg == nil {
...
func TestConfigSetGlobalGitWriteAllowRejectsInvalidBool(t *testing.T) {
	mock := &changeentry.MockConfigIO{}
	err := configSet("git.write.allow", []string{"yes"}, true, mock, false)
	if err == nil {
...
func TestConfigSetGlobalGitWriteAddChangeWritesUserConfig(t *testing.T) {
	mock := &changeentry.MockConfigIO{}
	err := configSet("git.write.add-change", []string{"false"}, true, mock, false)
	if err != nil {
		t.Fatalf("configSet returned error: %v", err)
	}
	if mock.WrittenUserCfg == nil {
...
func TestConfigSetGlobalGitWriteCreateReleaseTagWritesUserConfig(t *testing.T) {
	mock := &changeentry.MockConfigIO{}
	err := configSet("git.write.create-release-tag", []string{"true"}, true, mock, false)
	if err != nil {
		t.Fatalf("configSet returned error: %v", err)
	}
	if mock.WrittenUserCfg == nil {
...
func TestConfigSetGlobalGitWritePushReleaseTagWritesUserConfig(t *testing.T) {
	mock := &changeentry.MockConfigIO{}
	err := configSet("git.write.push-release-tag", []string{"false"}, true, mock, false)
	if err != nil {
		t.Fatalf("configSet returned error: %v", err)
	}
	if mock.WrittenUserCfg == nil {
...
func TestConfigSetUnknownKeyReturnsError(t *testing.T) {
	mock := &changeentry.MockConfigIO{}
	err := configSet("unknown.key", []string{"value"}, true, mock, false)
	if err == nil {
...
func TestConfigUnsetGlobalDefaultsAudienceClearsField(t *testing.T) {
	...
	err := configUnset("defaults.audience", true, mock, false)
	if err != nil {
...
func TestConfigUnsetGlobalDefaultsRankClearsField(t *testing.T) {
	...
	err := configUnset("defaults.rank", true, mock, false)
	if err != nil {
		t.Fatalf("configUnset returned error: %v", err)
	}
	if mock.WrittenUserCfg == nil {
...
func TestConfigUnsetGlobalGitWriteAllowClearsField(t *testing.T) {
	...
	err := configUnset("git.write.allow", true, mock, false)
	if err != nil {
		t.Fatalf("configUnset returned error: %v", err)
	}
	if mock.WrittenUserCfg == nil {
...
func TestConfigUnsetUnknownKeyReturnsError(t *testing.T) {
	mock := &changeentry.MockConfigIO{}
	err := configUnset("unknown.key", true, mock, false)
	if err == nil {
		t.Fatal("expected error for unknown key")
	}
}
...
func TestConfigSetRepoDefaultsComponentWritesRepoConfig(t *testing.T) {
	mock := &changeentry.MockConfigIO{}
	err := configSet("defaults.component", []string{"api"}, false, mock, false)
	if err != nil {
		t.Fatalf("configSet returned error: %v", err)
	}
...
func TestConfigSetRepoDefaultsComponentPreservesExistingConfig(t *testing.T) {
	...
	err := configSet("defaults.component", []string{"sdk"}, false, mock, false)
	if err != nil {
		t.Fatalf("configSet returned error: %v", err)
	}
	if mock.WrittenRepoCfg == nil {
...
func TestConfigUnsetRepoDefaultsAudienceClearsField(t *testing.T) {
	...
	err := configUnset("defaults.audience", false, mock, false)
	if err != nil {
		t.Fatalf("configUnset returned error: %v", err)
	}
	if mock.WrittenRepoCfg == nil {
...
// ── release policy config keys ────────────────────────────────────────────────

func TestConfigSetReleaseVPrefixAlwaysWritesUserConfig(t *testing.T) {
	mock := &changeentry.MockConfigIO{}
	err := configSet("release.v-prefix", []string{"always"}, true, mock, false)
	if err != nil {
		t.Fatalf("configSet returned error: %v", err)
	}
	if mock.WrittenUserCfg == nil {
	...
	if mock.WrittenUserCfg.Release.VPrefix != "always" {
		t.Fatalf("expected release.v-prefix=always, got %q", mock.WrittenUserCfg.Release.VPrefix)
	}
}

func TestConfigSetReleaseVPrefixInvalidReturnsError(t *testing.T) {
	mock := &changeentry.MockConfigIO{}
	err := configSet("release.v-prefix", []string{"invalid"}, true, mock, false)
	if err == nil {
		t.Fatal("expected error for invalid release.v-prefix value")
	}
}

func TestConfigSetReleaseAliasTagsNeverWritesUserConfig(t *testing.T) {
	mock := &changeentry.MockConfigIO{}
	err := configSet("release.alias-tags", []string{"never"}, true, mock, false)
	if err != nil {
		t.Fatalf("configSet returned error: %v", err)
	}
	if mock.WrittenUserCfg == nil {
	...
	if mock.WrittenUserCfg.Release.AliasTags != "never" {
		t.Fatalf("expected release.alias-tags=never, got %q", mock.WrittenUserCfg.Release.AliasTags)
	}
}

func TestConfigSetReleaseAliasTagsInvalidReturnsError(t *testing.T) {
	mock := &changeentry.MockConfigIO{}
	err := configSet("release.alias-tags", []string{"badvalue"}, true, mock, false)
	if err == nil {
		t.Fatal("expected error for invalid release.alias-tags value")
	}
}

func TestConfigSetReleaseVPrefixAutoWritesUserConfig(t *testing.T) {
	mock := &changeentry.MockConfigIO{}
	err := configSet("release.v-prefix", []string{"auto"}, true, mock, false)
	if err != nil {
		t.Fatalf("configSet returned error: %v", err)
	}
	if mock.WrittenUserCfg == nil {
	...
	if mock.WrittenUserCfg.Release.VPrefix != "auto" {
		t.Fatalf("expected release.v-prefix=auto, got %q", mock.WrittenUserCfg.Release.VPrefix)
	}
}
