...
import (
	...
	"github.com/codested/chagg/internal/version"
	...
	cmd := &cli.Command{
		...
		Flags: []cli.Flag{
			...
			&cli.BoolFlag{
				Name:    "quiet",
				Aliases: []string{"q"},
				Usage:   "Suppress informational messages, only show data output and errors",
			},
		},
		Before: func(ctx context.Context, cmd *cli.Command) (context.Context, error) {
			...
			if cmd.Bool("quiet") {
				level = slog.LevelError // suppress warnings too
			}
